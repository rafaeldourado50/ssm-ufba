...
class RecordsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $achieved_disciplines = $data['achieved_disciplines'];

        return view('records.index', compact('disciplines'), compact('achieved_disciplines'));
    }
    ...
    public function getDisciplines($student_id, $course_id)
    {
        ...
        $achieved_disciplines = $achieved_disciplines->groupBy('nature');
        ...
        return ['disciplines' => $disciplines, 'achieved_disciplines' => $achieved_disciplines];
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach ($disciplines as $discipline){
            $create = AchievedDiscipline::create(['student_id' => $student['id'], 'discipline_id' => $discipline]);
