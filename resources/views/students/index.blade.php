                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Enrollment</th><th>Email</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($students as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->enrollment }}</td><td>{{ $item->email }}</td>
                                        <td>
                                            <a href="{{ url('/students/' . $item->id) }}" title="View student"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
