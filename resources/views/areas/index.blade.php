                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($areas as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/areas/' . $item->id) }}" title="View area"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/areas/' . $item->id . '/edit') }}" title="Edit area"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
