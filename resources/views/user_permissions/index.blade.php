  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">Permissão do Usuário</div>
        <div class="panel-body">

          <form method="POST" action="{{ url('/users/' . $user->id . '/permissions') }}" accept-charset="UTF-8" enctype="multipart/form-data">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">Lista de Permissões do Usuário</div>
        <div class="panel-body">
