            ...
            <table class="table table-borderless">
              ...
              @foreach($roles as $item)
                <tr>
                  <td>{{ $item->name }}</td>
                  <td>
                    <a href="{{ url('/roles/' . $item->id) }}" title="Show"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> </button></a>
                    <a href="{{ url('/roles/' . $item->id . '/edit') }}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></a>
